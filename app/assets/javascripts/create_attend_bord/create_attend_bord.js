window.addEventListener('load', function() {
	...
	$(document).on("click", '.monthly-day-event', function(event){
        ...
        html_content = 
		'<tr>' +
		`<td class="attend-td-schedule"><input type="text" class="attend-input-schedule" value="${month}/${day}" readonly></input></td>` +
		'<td class="attend-td-comment"><input type="text" class="attend-input-comment" name=""></input></td>' +
		'<td class="attend-td-schedule-delete"><input type="button" class="attend-input-schedule-delete" name=""></input></td>' +
		'</tr>';
