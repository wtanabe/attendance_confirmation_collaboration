window.addEventListener('load', function() {
  ...
  $(document).on("click", '.monthly-day-event', function(event){
    //行数取得
    var row = $('#attend-input-table').prop('rows').length;
    ...
    html_content = 
    '<tr>' +
    `<td class="attend-td-schedule data-id="1"><input type="text" name="event_date[${row-1}][event_date]" class="attend-input-schedule" value="${month}/${day}" readonly></input></td>` +
